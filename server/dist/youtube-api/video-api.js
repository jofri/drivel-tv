...
exports.storeVideosToDb = (videoIds) => __awaiter(this, void 0, void 0, function* () {
    ...
    function storeVideos(playlist) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield fetch('https://www.googleapis.com/youtube/v3/videos?part=snippet&part=contentDetails&id=' + playlist.toString() + '&key=' + process.env.YT_API_KEY);
            ...
            const vidObjArray = yield Promise.all(youtubeJSON.items.map((video) => __awaiter(this, void 0, void 0, function* () {
                ...
                // Store in DB
                yield Video.findOneAndUpdate({ youtubeId: video.id }, { $setOnInsert: vidObj }, // Insert document if it does not exist
                { upsert: true, new: true, runValidators: true }, function (error) {
                    if (error) {
                        console.log(error);
    ...
    return yield splitAndStore(videoIds);
});
